					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Empleados">
								<li class="nav-item"><a href="Listado_De_Empleados.html" class="nav-link">Listado de Empleados</a></li>
							<li class="nav-item"><a href="form_inputs.html" class="nav-link active">Registro de Empleados</a></li>
							<li class="nav-item"><a href="Actualizar_Registro.html" class="nav-link active">Actualizar Empleados</a></li>
							</ul>
						</li>
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Vacaciones">
								<li class="nav-item"><a href="Lista_De_Vacaciones.html" class="nav-link active">Lista de Vacaciones/Editar</a></li>
								<li class="nav-item"><a href="Solicitud_Vac.html" class="nav-link active">Solicitar Vacaciones</a></li>
							</ul>
						</li>
						...
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Departamentos">
								<li class="nav-item"><a href="Listado_De_Departamentos.html" class="nav-link">Listado de Departamentos</a></li>
							</ul>
						</li>
						...
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Empresas">
								<li class="nav-item"><a href="Listado_De_Empresas.html" class="nav-link">Lista de Empresas/Editar Empresa</a></li>
								<li class="nav-item"><a href="AgregarDep.html" class="nav-link">Agregar Empresa</a></li>
							</ul>
						</li>	
				</div>
				<!-- /main navigation -->
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="Listado_De_Empleados.html" class="breadcrumb-item">Empleados</a>
			...
			<div class="content">
				...
				<div class="card bg-grey-300">
					...
					<table class="table table-bordered">
						...
						<tbody>
							<tr>
							<td><a href="Actualizar_Registro.html" class="list-icons-item" data-popup="tooltip" title="Editar" data-container="body">
							...
							<tr class="table-danger">
								<td><a href="Actualizar_Registro.html" class="list-icons-item" data-popup="tooltip" title="Edit" data-container="body"><i class="icon-pencil7"></i></a><a href="#" class="list-icons-item" data-toggle="modal" data-target="#remove_modal"><i class="icon-trash"></i>
					    	    </td>
								<td>Jackelyn</td>
							...
							<tr>
							<td><a href="Actualizar_Registro.html" class="list-icons-item" data-popup="tooltip" title="Edit" data-container="body">
					        <i class="icon-pencil7"></i></a>
